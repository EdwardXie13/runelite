...
public class KarilsLeathertop extends ChargedItem {
    public KarilsLeathertop(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.KARILS_LEATHERTOP, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
