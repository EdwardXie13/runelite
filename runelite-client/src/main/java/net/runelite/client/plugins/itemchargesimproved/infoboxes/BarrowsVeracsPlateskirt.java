...
public class BarrowsVeracsPlateskirt extends ChargedItemInfoBox {
    public BarrowsVeracsPlateskirt(
        final Client client,
        ...
        super(ChargesItem.BARROWS_GEAR, ItemID.VERACS_PLATESKIRT, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, plugin);
        this.charges = 100;
