...
public class KarilsLeatherskirt extends ChargedItem {
    public KarilsLeatherskirt(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.KARILS_LEATHERSKIRT, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
