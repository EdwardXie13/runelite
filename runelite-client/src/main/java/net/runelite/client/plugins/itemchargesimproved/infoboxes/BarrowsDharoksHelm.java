...
public class BarrowsDharoksHelm extends ChargedItemInfoBox {
    public BarrowsDharoksHelm(
        final Client client,
        ...
        super(ChargesItem.BARROWS_GEAR, ItemID.DHAROKS_HELM, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, plugin);
        this.charges = 100;
