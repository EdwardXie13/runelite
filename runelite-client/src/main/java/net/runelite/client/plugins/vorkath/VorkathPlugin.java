...
public class VorkathPlugin extends Plugin
{
    ...
    static
    {
        ...
        ICE = ImageUtil.loadImageResource(VorkathPlugin.class, "ice.png");
        MAGERANGE = ImageUtil.loadImageResource(VorkathPlugin.class, "magerange.png");
    }
    ...
    public void onGameTick(GameTick event)
    {
        if (vorkath != null)
        {
            ...
            {
                if (animationId == VorkathIDs.VORKATH_ACID_ATTACK)
                {
                    vorkath.setPhase(2);
                    vorkath.setAttacksUntilSwitch(Vorkath.ATTACKS_PER_SWITCH);
                }
                else if (animationId == VorkathIDs.VORKATH_ATTACK && vorkath.getAttacksUntilSwitch() == 0)
                {
                    vorkath.setPhase(1);
                    vorkath.setAttacksUntilSwitch(Vorkath.ATTACKS_PER_SWITCH);
                ...
                else if (animationId == VorkathIDs.VORKATH_ATTACK || animationId == VorkathIDs.VORKATH_FIRE_BOMB_OR_SPAWN_ATTACK)
                {
