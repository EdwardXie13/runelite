...
public class BarrowsVeracsHelm extends ChargedItemInfoBox {
    public BarrowsVeracsHelm(
        final Client client,
        ...
        super(ChargesItem.BARROWS_GEAR, ItemID.VERACS_HELM, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, plugin);
        this.charges = 100;
