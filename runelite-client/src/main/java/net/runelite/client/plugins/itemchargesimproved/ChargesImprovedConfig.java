...
import net.runelite.client.plugins.itemchargesimproved.store.ItemActivity;

import java.awt.Color;

import static net.runelite.client.plugins.itemchargesimproved.ChargesImprovedConfig.group;
