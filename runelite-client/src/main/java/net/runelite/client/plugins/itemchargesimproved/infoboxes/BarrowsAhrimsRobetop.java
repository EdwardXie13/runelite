...
public class BarrowsAhrimsRobetop extends ChargedItemInfoBox {
    public BarrowsAhrimsRobetop(
        final Client client,
        ...
        super(ChargesItem.BARROWS_GEAR, ItemID.AHRIMS_ROBETOP, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, plugin);
        this.charges = 100;
