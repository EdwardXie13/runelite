    ...
    public static final List<Set<Pair<Integer, Integer>>> potionRecipe = new ArrayList<>(
        Arrays.asList(
            ...
            Set.of(Pair.of(ItemID.GUAM_POTION_UNF, 14), Pair.of(ItemID.EYE_OF_NEWT, 14)),
                ...
                Set.of(Pair.of(ItemID.CADANTINE_POTION_UNF, 14), Pair.of(ItemID.WINE_OF_ZAMORAK, 14)),
                Set.of(Pair.of(ItemID.CADANTINE_POTION_UNF, 14), Pair.of(ItemID.POTATO_CACTUS, 14)),
