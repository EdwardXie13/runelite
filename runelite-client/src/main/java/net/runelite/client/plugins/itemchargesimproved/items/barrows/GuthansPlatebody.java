...
public class GuthansPlatebody extends ChargedItem {
    public GuthansPlatebody(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.GUTHANS_PLATEBODY, client, client_thread, configs, items, infoboxes, chat_messages, notifier, config, store, gson);
