package net.runelite.client.plugins.summergarden;
...
import static net.runelite.client.plugins.summergarden.ShowNumbers.ON_WRONG;
import static net.runelite.client.plugins.summergarden.ShowNumbers.YES;
